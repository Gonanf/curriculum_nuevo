...
function Hero(){
    return(<GradientElement className=" [mask-image:radial-gradient(ellipse_at_center,black,transparent_90%)] bg-black" fromColor='rgba(191, 154, 206, 0.15)  0' toColor='rgba(255, 255, 255, 0)  100%'>
